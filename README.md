A Retrieval-Augmented Generation (RAG) system built with LangChain, ChromaDB, Hugging Face Embeddings, and Ollama Llama 3 for document-based question answering.
